...
- [x] [The lethal trifecta for AI agents: private data, untrusted content, and external communication](https://simonwillison.net/2025/Jun/16/the-lethal-trifecta/)
- [x] [Sandboxes for AI](https://www.luiscardoso.dev/blog/sandboxes-for-ai)
...
- [x] [Elixir Protocols: a gentle introduction](https://alchemist.camp/episodes/elixir-protocols-intro)
